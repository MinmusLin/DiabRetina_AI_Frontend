...
export default function data() {
  ...
  return {
    columns: [
      {Header: "患者", accessor: "author", width: "45%", align: "left"},
      {Header: "性别", accessor: "function", align: "left"},
      {Header: "年龄", accessor: "employed", align: "center"},
      {Header: "时间", accessor: "action", align: "center"},
    ],
    rows: [
      {
